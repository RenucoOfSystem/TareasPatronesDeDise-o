...
public class Android implements IEmpresaAplicaciones{

    private String usuario;
    private String pwd;
    private String reportes;

    public Android(String usuario, String pwd, String reportes) {
        System.out.println("Creando aplicacion para android");
